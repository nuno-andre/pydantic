...
def test_conlist():
    ...
    assert Model.schema() == {
        ...
        'type': 'object',
        'properties': {
            'foo': {'title': 'Foo', 'type': 'array', 'items': {'type': 'integer'}, 'minItems': 2, 'maxItems': 4, 'uniqueItems': False},
            'bar': {'title': 'Bar', 'type': 'array', 'items': {'type': 'string'}, 'minItems': 1, 'maxItems': 4, 'uniqueItems': False},
        },
        'required': ['foo'],
    }
